...
export const Hero = () => {
	return (
		<section className="hero-pattern">
			<div className="h-full max-w-7xl mx-auto relative min-h-screen flex flex-col py-16 lg:py-32 px-8 ">
				...
				<div className="mt-auto">
					...
					<div className="text-sm sm:text-md lg:text-lg text-slate-900 dark:text-gray-100 flex flex-col items-center md:flex-row md:justify-between gap-8 md:gap-32">
						<p>
							...
							years by vocation. The creation of applications is a passion
							before being a profession.
						</p>
